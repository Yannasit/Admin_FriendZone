            ...
            <div class="row justify-content-center">
                <div class="col-md-12 ">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url(https://cdn.discordapp.com/attachments/687292314988707850/948135095959699507/d.jpg);">
                        </div>
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form action="/Officer/register" method="post" class="signin-form">
                                <div class="row">
                                    <div class="col ">
